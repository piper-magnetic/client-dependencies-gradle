...
The original plugin was not compatible with Gradle versions 3 or higher due to a breaking change in the String wrapping packages.
It has been updated and pushed to the Gradle Plugin repository for usage.
